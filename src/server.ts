...
console.log(payments ? `Payments enabled: ${payments.options.map((option) => option.label).join(", ")}` : "Payments are not configured (FACILITATOR, PAY_TO_*, *_RPC_URL); top-ups are disabled.");
